...
# and iterable as inputs, and returns an iterator that applies 
# the function to each element of the iterable. The code below uses 
# map() to find the mean of each list in numbers to create the list averages. 
...
# from the iterable for which the function returns True. The code below 
# uses filter() to get the names in cities that are fewer than 
